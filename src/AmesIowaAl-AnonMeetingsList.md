...
# Keep the Meeting Schedule footer date tied to this file's modification time.
date: Last Modified
...
using the details frontmatter variable from each file. The details are written in markdown so there is a filter in eleventy.js file called markdownify that renders the details first!!
